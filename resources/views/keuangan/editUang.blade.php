<input type="hidden" name="id_keuangan" value="{{$uang->id_keuangan}}" id="id_data">
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input type="text" id="total_biaya_sdbln" name="total_biaya_sdbln"  class="form-control" value="{{$uang->total_biaya_sdbln}}">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input type="text" id="total_biaya_bln" name="total_biaya_bln"  class="form-control" value="{{$uang->total_biaya_bln}}">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input type="text" id="total_laba_sdbln" name="total_laba_sdbln"  class="form-control" value="{{$uang->total_laba_sdbln}}">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input type="text" id="total_laba_bln" name="total_laba_bln"  class="form-control" value="{{$uang->total_laba_bln}}">
